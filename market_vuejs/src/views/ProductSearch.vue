<template>
  <div>
    ...
    <section class="shop-page section-padding-0-100">
      <div class="container">
          <div class="row">
              <form @submit.prevent="searchProducts" class="input-group col-md-4 search-group">
                  <input class="form-control py-2 border-right-0 border" type="search" :value="$route.params.slug?$route.params.slug:''" id="product-search-input">
          ...
          <form id="filter-area" @submit.prevent="filterProducts" class="col-12 col-md-4 col-lg-3">
            <div class="shop-sidebar-area">
              <div class="shop-widget catagory mb-50">
                ...
                <div class="widget-desc">
                  ...
                  <div v-for="category in categories" class="custom-control custom-checkbox d-flex align-items-center mb-2">
                    <input :value="category.id" name="category[]" type="checkbox" class="custom-control-input" :id="`customCheck${category.id}`" :checked="$route.query['category[]']?($route.query['category[]'].includes(category.id.toString())?'checked':''):''">
              ...
              <div class="shop-widget price mb-50">
                ...
                <div class="widget-desc">
                  <div class="slider-range">
                    <div id="slider-range-price" data-min="8" data-max="30" data-unit="$" class="slider-range-price ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" :data-value-min="$route.query.from_price?$route.query.from_price:399" :data-value-max="$route.query.to_price?$route.query.to_price:4000" data-label-result="Price:">
                    </div>
                    <div class="range-price">
                      <div class="form-group row">
                        <label for="from_price" class="col-2 col-form-label">{{$t('from')}}</label>
                        <div class="col-4">
                          <input id="from_price" type="text" class="form-control " name="from_price" :value="$route.query.from_price?$route.query.from_price:399">
                        </div>
                        <label for="to_price" class="col-form-label">{{$t('to')}}</label>
                        <div class="col-4">
                          <input id="to_price" type="text" class="form-control" name="to_price" :value="$route.query.to_price?$route.query.to_price:4000">
                        </div>
              ...
              <div class="shop-widget catagory mb-50">
                ...
                <div class="widget-desc">
                  ...
                  <div v-for="volume in volumes" class="custom-control custom-checkbox d-flex align-items-center mb-2">
                    <input :value="volume" name="volume[]" type="checkbox" class="custom-control-input" :id="`customCheckvol${volume}`" :checked="$route.query['volume[]']?($route.query['volume[]'].includes(volume.toString())?'checked':''):''">
              ...
              <div class="shop-widget catagory mb-50">
                ...
                <div class="widget-desc">
                  <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                    <input value="universal" name="aroma[]" type="checkbox" class="custom-control-input" id="customCheckaroma" :checked="$route.query['aroma[]']?($route.query['aroma[]'].includes('universal')?'checked':''):''">
              ...
              <div class="shop-widget catagory mb-50">
                ...
                <div class="widget-desc">
                  <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                    <input value="woman" name="type[]" type="checkbox" class="custom-control-input" id="customCheckforwoman" :checked="$route.query['type[]']?($route.query['type[]'].includes('woman')?'checked':''):''">
                    <label class="custom-control-label" for="customCheckforwoman">{{$t('Woman')}}</label>
                  </div>
                  <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                    <input value="man" name="type[]" type="checkbox" class="custom-control-input" id="customCheckformen" :checked="$route.query['type[]']?($route.query['type[]'].includes('man')?'checked':''):''">
                    <label class="custom-control-label" for="customCheckformen">{{$t('Man')}}</label>
                  </div>
                  <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                    <input value="unisex" name="type[]" type="checkbox" class="custom-control-input" id="customCheckforuni" :checked="$route.query['type[]']?($route.query['type[]'].includes('unisex')?'checked':''):''">
  ...
  export default {
    ...
    created() {
      ...
      if(this.$route.query){
        ...
        this.getProducts(this.$ApiHost+'/api/search-product/'+this.$route.params.slug+'?'+queryString);
      }else {
        this.getProducts();
      }
    ...
    methods: {
      getProducts(page_url) {
        page_url = page_url || this.$ApiHost+'/api/search-product/'+this.$route.params.slug;
      ...
      filterProducts() {
        ...
        this.$router.push({ path: `/${this.$i18n.locale}/product/search/${this.$route.params.slug}?${querystring}` })
      },
      searchProducts() {
        let querystring = $('#product-search-input').val();
        if(querystring) {
