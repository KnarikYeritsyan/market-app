...
return [
    ...
    */
    ...
    'max' => [
        ...
        'string' => ':attribute դաշտի նիշերի քանակը չի կարող լինել :max-ից մեծ։',
    ...
    */
    ...
    'attributes' => [
        ...
        'name_en'               => 'Անուն',
        'name_am'               => 'Անուն',
        'description_ru'        => 'Նկարագրություն',
        'description_en'        => 'Նկարագրություն',
        'description_am'        => 'Նկարագրություն',
        'excerpt_ru'            => 'Քաղվածք',
        'excerpt_em'            => 'Քաղվածք',
        'excerpt_am'            => 'Քաղվածք',
        'price'                 => 'Գին',
        ...
        'title_en'              => 'Վերնագիր',
        'title_am'              => 'Վերնագիր',
        'content_ru'            => 'Բովանդակություն',
        'content_en'            => 'Բովանդակություն',
        'content_am'            => 'Բովանդակություն',
    ],
];
